...
package local_project.controlbuspocroute_0_1;
...
/**
 * Job: ControlBusPOCRoute Purpose: <br>
 * Description: <br>
 * 
...
public class ControlBusPOCRoute extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		ControlBusPOCRoute.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("timer:cTimer_1" + "?period=" + 100000 + "&delay=" + 1000 + "&fixedRate=true")
				.routeId("ControlBusPOCRoute_cTimer_1")
				.log(org.apache.camel.LoggingLevel.INFO, "ControlBusPOCRoute.cLog_1", "hellooooworld")

				.id("ControlBusPOCRoute_cLog_1").stop().id("ControlBusPOCRoute_cStop_1");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/controlbuspocroute.xml"));
				camelContext.setName("ControlBusPOCRoute");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "ControlBusPOCRoute");
				try {
				...
				targetNodeToConnectionMap.put("ControlBusPOCRoute_cLog_1", "route1");
				targetNodeToConnectionMap.put("ControlBusPOCRoute_cStop_1", "route2");
	...
	public static void main(String[] args) {
		int exitCode = new ControlBusPOCRoute().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = ControlBusPOCRoute.class.getClassLoader().getResourceAsStream(
					"local_project/controlbuspocroute_0_1/contexts/" + contextName + ".properties");
