...
package local_project.filedelimitedroute_0_1;
...
/**
 * Job: FileDelimitedRoute Purpose: <br>
 * Description: <br>
 * 
...
public class FileDelimitedRoute extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		FileDelimitedRoute.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("timer:cTimer_1" + "?period=" + 10000 + "&delay=" + 1000 + "&fixedRate=true")
				.routeId("FileDelimitedRoute_cTimer_1").setBody().simple("${date:now}")
				.id("FileDelimitedRoute_cSetBody_1").convertBodyTo(String.class)
				.id("FileDelimitedRoute_cConvertBodyTo_1")
				.log(org.apache.camel.LoggingLevel.WARN, "FileDelimitedRoute.cLog_1",
						"writing a file...." + context.targetPath + " with file name as " + context.fileNameProp)

				.id("FileDelimitedRoute_cLog_1").to("file://" + context.targetPath + "?noop=true" + "&autoCreate=true"
						+ "&flatten=false" + "&fileName=" + context.fileNameProp + "&bufferSize=128")
				.id("FileDelimitedRoute_cFile_1");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/filedelimitedroute.xml"));
				camelContext.setName("FileDelimitedRoute");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "FileDelimitedRoute");
				try {
				...
				targetNodeToConnectionMap.put("FileDelimitedRoute_cSetBody_1", "route1");
				targetNodeToConnectionMap.put("FileDelimitedRoute_cConvertBodyTo_1", "route2");
				targetNodeToConnectionMap.put("FileDelimitedRoute_cLog_1", "route4");
				targetNodeToConnectionMap.put("FileDelimitedRoute_cFile_1", "route3");
	...
	public static class ContextProperties extends Properties {
		...
		public void synchronizeContext() {
			if (targetPath != null) {
				this.setProperty("targetPath", targetPath.toString());
			}
			if (fileNameProp != null) {
				this.setProperty("fileNameProp", fileNameProp.toString());
			}
			if (greeting != null) {
	...
	private static String contextStr = "DEV";
	...
	public static void main(String[] args) {
		int exitCode = new FileDelimitedRoute().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = FileDelimitedRoute.class.getClassLoader().getResourceAsStream(
					"local_project/filedelimitedroute_0_1/contexts/" + contextName + ".properties");
			...
			context.targetPath = (String) context.getProperty("targetPath");
			context.fileNameProp = (String) context.getProperty("fileNameProp");
