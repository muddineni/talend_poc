...
package local_project.xmlconsumeramq_0_1;
 ...
 */
    ...
    public class XMLConsumerAMQ extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		XMLConsumerAMQ.arguments = arguments;
	...
	final String decryptedPassword_cMQConnectionFactory_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:YW5whWSGs/Nfqlsh5LzfLXBz8LjbzUK7oC2JZ7GjmkTX");
                        javax.jms.ConnectionFactory jmsConnectionFactory_cMQConnectionFactory_1 =
                            new org.apache.activemq.ActiveMQConnectionFactory( "admin", decryptedPassword_cMQConnectionFactory_1 ,"tcp://localhost:61616");
                        org.apache.activemq.pool.PooledConnectionFactory pooledConnectionFactory_cMQConnectionFactory_1
                            = new org.apache.activemq.pool.PooledConnectionFactory();
                        pooledConnectionFactory_cMQConnectionFactory_1.setConnectionFactory(jmsConnectionFactory_cMQConnectionFactory_1);
                        pooledConnectionFactory_cMQConnectionFactory_1.setExpiryTimeout(Long.valueOf(60000));
                        pooledConnectionFactory_cMQConnectionFactory_1.setIdleTimeout(30000);
                        pooledConnectionFactory_cMQConnectionFactory_1.setMaxConnections(1);
                        pooledConnectionFactory_cMQConnectionFactory_1.setMaximumActiveSessionPerConnection(500);

                        if(camelContext.getComponent("cMQConnectionFactory1")==null){
                                                    camelContext.addComponent("cMQConnectionFactory1",
                            org.apache.camel.component.jms.JmsComponent.jmsComponent(pooledConnectionFactory_cMQConnectionFactory_1));
                        }


		from("cMQConnectionFactory1:queue:queue.firstqueue")
.routeId("XMLConsumerAMQ_cJMS_1")			.to("xslt://samplesoapresponse.xslt")
.id("XMLConsumerAMQ_cMessagingEndpoint_2")			.to("file://C:/Users/584976/OneDrive - Cognizant/Documents/talend_test?fileName=transformedxml_22ndjuly.txt")
.id("XMLConsumerAMQ_cMessagingEndpoint_1");	}
            ...
            protected CamelContext createContext() {
                final org.apache.camel.impl.DefaultCamelContext camelContext =
                    new org.apache.camel.spring.SpringCamelContext(
                        new org.springframework.context.support.ClassPathXmlApplicationContext("META-INF/spring/xmlconsumeramq.xml"));
                camelContext.setName("XMLConsumerAMQ");
                // add notifier
	...
	private final Properties context_param = new Properties();
        ...
        public static void main(String[] args){
            int exitCode = new XMLConsumerAMQ().runJobInTOS(args);
            if(exitCode != 0) {
    ...
    public int runJobInTOS(String[] args) {
		...
		return 0;
            ...
            private void readContextValues(String contextName){
                ...
                try {
                    java.io.InputStream inContext = XMLConsumerAMQ.class.getClassLoader().getResourceAsStream("local_project/xmlconsumeramq_0_1/contexts/"+contextName+".properties");
